		...
		<Box sx={{ display: 'flex', height: '100vh' }}>
			...
			<AppBar elevation={0} position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1 }}>
				<Toolbar>
					...
					<Box display="flex">
						<IconButton
							onClick={() => window.open('https://yarnpkg.com/package/mui-image')}
							color="inherit"
						>
							<YarnIcon viewBox="0 0 256 256" fontSize="large" color="inherit" />
						</IconButton>
						<IconButton
						...
						<IconButton
							onClick={() => window.open('https://github.com/benmneb/mui-image')}
							color="inherit"
						>
			...
			>
				<Toolbar />
				<Stack spacing={2} component="section" padding={2} sx={{ minWidth: '100%' }}>
					<Box component="div" variant="h6">
						{'<Image'}
					</Box>
					<Stack spacing={1} sx={{ pl: 2 }}>
						<Line component="div">src="https://picsum.photos/id/{currentPhoto}/2000"</Line>
						...
						<Tooltip title="Any valid CSS `transition-timing-function` property" placement="right">
							<Line component="div">
								easing=
								<Select
									variant="standard"
						...
						<Tooltip title="Once installed you can add a custom error icon" placement="right">
							<Line component="div">
								errorIcon=
								<FormControlLabel
									sx={{ ml: 0 }}
									control={
										<Switch checked={errorIcon} onChange={(e) => setErrorIcon(e.target.checked)} />
									}
									label={`{ ${errorIcon} }`}
									labelPlacement="start"
								/>
						...
						<Tooltip title="Direction to shift image as it appears" placement="right">
							<Line component="div">
								shift=
								<Select
									variant="standard"
						...
						<Tooltip title="Number of milliseconds the shift takes" placement="right">
							<Line component="div">
								shiftDuration={'{'}
								<TextField
									variant="standard"
					...
					<Button disabled={showPhoto === 'new'} variant="outlined" onClick={getNewPhoto}>
						Random photo
					</Button>
